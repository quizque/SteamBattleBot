...
namespace SteamBattleBot.Structures
{
    class PlayerStructure
    {
        ...
        /// <summary>
        /// Handles message input from user.
        /// </summary>
        /// <param name="callBack">Friend message callBack.</param>
        /// <param name="steamFriends">Steam friends handel.</param>
        /// <param name="message">Users message to be processed.</param>
        /// <returns>Returns true if message was valid command, false if not.</returns>
        public bool HandleMessage(SteamFriends.FriendMsgCallback callBack, SteamFriends steamFriends, string message)
        {
            switch (callBack.Message)
            {
                ...
                case "!attack":
                    Attack(callBack, steamFriends);
                    return true;

                case "!special":
                    Special(callBack, steamFriends);
                    return true;

                case "!block":
                    Block(callBack, steamFriends);
                    return true;

                case "!shop":
                    DisplayShop(callBack, steamFriends);
                    return true;

                case "!stats":
                    Stats(callBack, steamFriends);
                    return true;
